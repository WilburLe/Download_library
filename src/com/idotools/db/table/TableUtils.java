...
import com.idotools.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.idotools.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.idotools.db.table.Id>();

    /* package */
    static synchronized com.idotools.db.table.Id getId(Class<?> entityType) {
        ...
        com.idotools.db.table.Id id = new com.idotools.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.idotools.db.table.Id id = getId(entityType);
